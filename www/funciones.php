<?php
	...
	*/
	...
	/**
	* Esta función se encarga de traer información sin importar la tablas.
	...
	* la fucnión como tal esté bién construida, que es algo a lo que un programador se debe acostumbrar. De allí en 
